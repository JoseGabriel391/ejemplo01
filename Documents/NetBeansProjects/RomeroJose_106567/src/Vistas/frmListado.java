...
public class frmListado extends javax.swing.JFrame {
    ...
    public void llenarTabla(){
        ...
        model.setColumnIdentifiers(new String[]{"Visita", "Paciente", "Empleado", "Duracion"});
        
        for (Visita v : lista) {
            model.addRow(new Object[] {v.getNombre(), v.getIdPaciente().getNombre(), v.getLegajoRecepcionista().getNombre(), v.getDuracion()});
        }
        tblVisitas.setModel(model);
    }
    /**
